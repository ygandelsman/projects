...
First I tried to understand how to crawl scrape and http files.
...
I also wrote another scraper/crawler ("readEmails.py") that inserts to every url 
in "links.txt" and for every url, it checks the contant of the http page. 
...
I use linux functions to delete duplicates in files and append files.
